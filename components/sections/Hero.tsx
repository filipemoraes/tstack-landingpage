...
export function Hero() {
  return (
    <section className="hero-section relative overflow-hidden bg-white pt-[200px] pb-20 max-[768px]:pt-[120px] max-[768px]:pb-[50px]">
      ...
      <div className="hero-bg absolute inset-x-5 top-5 bottom-0 z-0 pointer-events-none overflow-hidden rounded-[24px]">
        <svg
      ...
      <Container className="relative z-[2] !text-center !max-w-[920px]">
        <h1 style={{ color: "white" }} className="px-[20px] md:px-0">
          Confiança imutável
          <br />
          <span className="grad-text-animated">para cada evento crítico</span>
        </h1>
        <p
          className="mt-7 leading-[1.55] max-w-[640px] mx-auto max-[768px]:!text-base px-[20px] md:px-0"
        ...
        <div className="mt-10 flex gap-3.5 justify-center flex-wrap px-[20px] md:px-0">
